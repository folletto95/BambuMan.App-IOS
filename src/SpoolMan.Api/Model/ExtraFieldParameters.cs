...
namespace SpoolMan.Api.Model
{
    ...
    public partial class ExtraFieldParameters : IValidatableObject
    {
        ...
        [JsonConstructor]
        public ExtraFieldParameters(string name, ExtraFieldType fieldType, Option<int?> order = default, Option<string?> unit = default, Option<string?> defaultValue = default, Option<List<string>?> choices = default, Option<bool?> multiChoice = default)
        {
            Name = name;
            FieldType = fieldType;
            OrderOption = order;
    ...
    /// <summary>
    /// A Json converter for type <see cref="ExtraFieldParameters" />
    /// </summary>
    public class ExtraFieldParametersJsonConverter : JsonConverter<ExtraFieldParameters>
    {
        /// <summary>
        /// Deserializes json to <see cref="ExtraFieldParameters" />
        /// </summary>
        ...
        public override ExtraFieldParameters Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class ExtraFieldParameters.", nameof(name));

            if (!fieldType.IsSet)
                throw new ArgumentException("Property is required for class ExtraFieldParameters.", nameof(fieldType));

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class ExtraFieldParameters.");

            if (fieldType.IsSet && fieldType.Value == null)
                throw new ArgumentNullException(nameof(fieldType), "Property is not nullable for class ExtraFieldParameters.");

            if (order.IsSet && order.Value == null)
                throw new ArgumentNullException(nameof(order), "Property is not nullable for class ExtraFieldParameters.");

            return new ExtraFieldParameters(name.Value!, fieldType.Value!.Value!, order, unit, defaultValue, choices, multiChoice);
        }

        /// <summary>
        /// Serializes a <see cref="ExtraFieldParameters" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="extraFieldParameters"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ExtraFieldParameters extraFieldParameters, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, extraFieldParameters, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ExtraFieldParameters" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="extraFieldParameters"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ExtraFieldParameters extraFieldParameters, JsonSerializerOptions jsonSerializerOptions)
        {
            if (extraFieldParameters.Name == null)
                throw new ArgumentNullException(nameof(extraFieldParameters.Name), "Property is required for class ExtraFieldParameters.");

            writer.WriteString("name", extraFieldParameters.Name);

            var fieldTypeRawValue = ExtraFieldTypeValueConverter.ToJsonValue(extraFieldParameters.FieldType);
            writer.WriteString("field_type", fieldTypeRawValue);

            if (extraFieldParameters.OrderOption.IsSet)
                writer.WriteNumber("order", extraFieldParameters.OrderOption.Value!.Value);

            if (extraFieldParameters.UnitOption.IsSet)
                if (extraFieldParameters.UnitOption.Value != null)
                    writer.WriteString("unit", extraFieldParameters.Unit);
                else
                    writer.WriteNull("unit");

            if (extraFieldParameters.DefaultValueOption.IsSet)
                if (extraFieldParameters.DefaultValueOption.Value != null)
                    writer.WriteString("default_value", extraFieldParameters.DefaultValue);
                else
                    writer.WriteNull("default_value");

            if (extraFieldParameters.ChoicesOption.IsSet)
                if (extraFieldParameters.ChoicesOption.Value != null)
                {
                    writer.WritePropertyName("choices");
                    JsonSerializer.Serialize(writer, extraFieldParameters.Choices, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("choices");
            if (extraFieldParameters.MultiChoiceOption.IsSet)
                if (extraFieldParameters.MultiChoiceOption.Value != null)
                    writer.WriteBoolean("multi_choice", extraFieldParameters.MultiChoiceOption.Value!.Value);
                else
