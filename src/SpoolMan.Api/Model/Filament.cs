...
namespace SpoolMan.Api.Model
{
    ...
    public partial class Filament : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="id">Unique internal ID of this filament type.</param>
        /// <param name="registered">When the filament was registered in the database. UTC Timezone.</param>
        ...
        /// <param name="extra">Extra fields for this filament. All values are JSON-encoded data. Query the /fields endpoint for more details about the fields.</param>
        ...
        [JsonConstructor]
        public Filament(int id, string registered, decimal density, decimal diameter, Dictionary<string, string> extra, Option<string?> name = default, Option<Vendor?> vendor = default, Option<string?> material = default, Option<decimal?> price = default, Option<decimal?> weight = default, Option<decimal?> spoolWeight = default, Option<string?> articleNumber = default, Option<string?> comment = default, Option<int?> settingsExtruderTemp = default, Option<int?> settingsBedTemp = default, Option<string?> colorHex = default, Option<string?> multiColorHexes = default, Option<SpoolmanApiV1ModelsMultiColorDirection?> multiColorDirection = default, Option<string?> externalId = default)
        {
            Id = id;
        ...
        public Option<SpoolmanApiV1ModelsMultiColorDirection?> MultiColorDirectionOption { get; private set; }

        /// <summary>
        /// Gets or Sets MultiColorDirection
        /// </summary>
        [JsonPropertyName("multi_color_direction")]
        public SpoolmanApiV1ModelsMultiColorDirection? MultiColorDirection { get { return this.MultiColorDirectionOption; } set { this.MultiColorDirectionOption = new(value); } }
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Vendor?> VendorOption { get; private set; }

        /// <summary>
        /// Gets or Sets Vendor
        /// </summary>
        [JsonPropertyName("vendor")]
        public Vendor? Vendor { get { return this.VendorOption; } set { this.VendorOption = new(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Filament" />
    /// </summary>
    public class FilamentJsonConverter : JsonConverter<Filament>
    {
        /// <summary>
        /// Deserializes json to <see cref="Filament" />
        /// </summary>
        ...
        public override Filament Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SpoolmanApiV1ModelsMultiColorDirection?> multiColorDirection = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "name":
                            ...
                            break;
                        case "vendor":
                            vendor = new Option<Vendor?>(JsonSerializer.Deserialize<Vendor>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        case "material":
                        ...
                        case "multi_color_direction":
                            ...
                            if (multiColorDirectionRawValue != null)
                                multiColorDirection = new Option<SpoolmanApiV1ModelsMultiColorDirection?>(SpoolmanApiV1ModelsMultiColorDirectionValueConverter.FromStringOrDefault(multiColorDirectionRawValue));
                            break;
                        case "external_id":
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class Filament.", nameof(id));

            if (!registered.IsSet)
                throw new ArgumentException("Property is required for class Filament.", nameof(registered));

            if (!density.IsSet)
                throw new ArgumentException("Property is required for class Filament.", nameof(density));

            if (!diameter.IsSet)
                throw new ArgumentException("Property is required for class Filament.", nameof(diameter));

            if (!extra.IsSet)
                throw new ArgumentException("Property is required for class Filament.", nameof(extra));

            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class Filament.");

            if (registered.IsSet && registered.Value == null)
                throw new ArgumentNullException(nameof(registered), "Property is not nullable for class Filament.");

            if (density.IsSet && density.Value == null)
                throw new ArgumentNullException(nameof(density), "Property is not nullable for class Filament.");

            if (diameter.IsSet && diameter.Value == null)
                throw new ArgumentNullException(nameof(diameter), "Property is not nullable for class Filament.");

            if (extra.IsSet && extra.Value == null)
                throw new ArgumentNullException(nameof(extra), "Property is not nullable for class Filament.");

            return new Filament(id.Value!.Value!, registered.Value!, density.Value!.Value!, diameter.Value!.Value!, extra.Value!, name, vendor, material, price, weight, spoolWeight, articleNumber, comment, settingsExtruderTemp, settingsBedTemp, colorHex, multiColorHexes, multiColorDirection, externalId);
        }

        /// <summary>
        /// Serializes a <see cref="Filament" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="filament"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Filament filament, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, filament, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Filament" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="filament"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Filament filament, JsonSerializerOptions jsonSerializerOptions)
        {
            if (filament.Registered == null)
                throw new ArgumentNullException(nameof(filament.Registered), "Property is required for class Filament.");

            if (filament.Extra == null)
                throw new ArgumentNullException(nameof(filament.Extra), "Property is required for class Filament.");

            writer.WriteNumber("id", filament.Id);

            writer.WriteString("registered", filament.Registered);

            writer.WriteNumber("density", filament.Density);

            writer.WriteNumber("diameter", filament.Diameter);

            writer.WritePropertyName("extra");
            JsonSerializer.Serialize(writer, filament.Extra, jsonSerializerOptions);
            if (filament.NameOption.IsSet)
                if (filament.NameOption.Value != null)
                    writer.WriteString("name", filament.Name);
                else
                    writer.WriteNull("name");

            if (filament.VendorOption.IsSet)
                if (filament.VendorOption.Value != null)
                {
                    writer.WritePropertyName("vendor");
                    JsonSerializer.Serialize(writer, filament.Vendor, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("vendor");
            if (filament.MaterialOption.IsSet)
                if (filament.MaterialOption.Value != null)
                    writer.WriteString("material", filament.Material);
                else
                    writer.WriteNull("material");

            if (filament.PriceOption.IsSet)
                if (filament.PriceOption.Value != null)
                    writer.WriteNumber("price", filament.PriceOption.Value!.Value);
                else
                    writer.WriteNull("price");

            if (filament.WeightOption.IsSet)
                if (filament.WeightOption.Value != null)
                    writer.WriteNumber("weight", filament.WeightOption.Value!.Value);
                else
                    writer.WriteNull("weight");

            if (filament.SpoolWeightOption.IsSet)
                if (filament.SpoolWeightOption.Value != null)
                    writer.WriteNumber("spool_weight", filament.SpoolWeightOption.Value!.Value);
                else
                    writer.WriteNull("spool_weight");

            if (filament.ArticleNumberOption.IsSet)
                if (filament.ArticleNumberOption.Value != null)
                    writer.WriteString("article_number", filament.ArticleNumber);
                else
                    writer.WriteNull("article_number");

            if (filament.CommentOption.IsSet)
                if (filament.CommentOption.Value != null)
                    writer.WriteString("comment", filament.Comment);
                else
                    writer.WriteNull("comment");

            if (filament.SettingsExtruderTempOption.IsSet)
                if (filament.SettingsExtruderTempOption.Value != null)
                    writer.WriteNumber("settings_extruder_temp", filament.SettingsExtruderTempOption.Value!.Value);
                else
                    writer.WriteNull("settings_extruder_temp");

            if (filament.SettingsBedTempOption.IsSet)
                if (filament.SettingsBedTempOption.Value != null)
                    writer.WriteNumber("settings_bed_temp", filament.SettingsBedTempOption.Value!.Value);
                else
                    writer.WriteNull("settings_bed_temp");

            if (filament.ColorHexOption.IsSet)
                if (filament.ColorHexOption.Value != null)
                    writer.WriteString("color_hex", filament.ColorHex);
                else
                    writer.WriteNull("color_hex");

            if (filament.MultiColorHexesOption.IsSet)
                if (filament.MultiColorHexesOption.Value != null)
                    writer.WriteString("multi_color_hexes", filament.MultiColorHexes);
                else
                    writer.WriteNull("multi_color_hexes");

            if (filament.MultiColorDirectionOption.IsSet)
                if (filament.MultiColorDirectionOption!.Value != null)
                {
                    var multiColorDirectionRawValue = SpoolmanApiV1ModelsMultiColorDirectionValueConverter.ToJsonValue(filament.MultiColorDirectionOption.Value!.Value);
                    writer.WriteString("multi_color_direction", multiColorDirectionRawValue);
                }
                else
                    writer.WriteNull("multi_color_direction");
            if (filament.ExternalIdOption.IsSet)
                if (filament.ExternalIdOption.Value != null)
                    writer.WriteString("external_id", filament.ExternalId);
                else
