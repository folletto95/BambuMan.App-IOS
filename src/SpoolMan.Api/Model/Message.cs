...
namespace SpoolMan.Api.Model
{
    ...
    public partial class Message : IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="varMessage">varMessage</param>
        [JsonConstructor]
        public Message(string varMessage)
        {
    ...
    public class MessageJsonConverter : JsonConverter<Message>
    {
        ...
        public override Message Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<string?> varMessage = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "message":
                            varMessage = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!varMessage.IsSet)
                throw new ArgumentException("Property is required for class Message.", nameof(varMessage));

            if (varMessage.IsSet && varMessage.Value == null)
                throw new ArgumentNullException(nameof(varMessage), "Property is not nullable for class Message.");

            return new Message(varMessage.Value!);
        }
        ...
        {
            if (message.VarMessage == null)
                throw new ArgumentNullException(nameof(message.VarMessage), "Property is required for class Message.");

            writer.WriteString("message", message.VarMessage);
        }
    }
}
