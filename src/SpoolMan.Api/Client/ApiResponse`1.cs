...
namespace SpoolMan.Api.Client
{
    ...
    /// </summary>
    /// <typeparam name="TType"></typeparam>
    public interface ICustomHttpStatusCode299<TType> : IApiResponse
    {
        /// <summary>
        /// Deserializes the response if the response is CustomHttpStatusCode299
        /// </summary>
        /// <returns></returns>
        TType CustomHttpStatusCode299();

        /// <summary>
        /// Returns true if the response is CustomHttpStatusCode299 and the deserialized response is not null
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        bool TryCustomHttpStatusCode299([NotNullWhen(true)]out TType? result);
    }
